...
RadioGroup.addButton(rb_ans1) # type: ignore
RadioGroup.addButton(rb_ans2) # type: ignore
RadioGroup.addButton(rb_ans3) # type: ignore
RadioGroup.addButton(rb_ans4) # type: ignore
